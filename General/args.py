...
def get_args():
    ...
    parser.add_argument('--file_path', type=str, default="input.txt", help='Path of the input file')
    parser.add_argument('--output', type=str,  default="output.txt", help='Path of the csv program output file')
    ...
    parser.add_argument('--apply_threshold', action='store_true', help='Apply efficiency thresholds if this flag is set')
    ...
    parser.add_argument('--merge_bins', action='store_true', help='Choose whether to merge bins (for the relaxed version)')
